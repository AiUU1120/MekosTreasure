...
public class BatController : Enemy, IEndGameObserver
{
    #region DEFINITION
    ...
    protected override void Awake()
    {
        ...
        col_collision = transform.Find("AttackedArea_Bat").GetComponent<Collider2D>();
        col_dash = transform.Find("DashAttackArea_Bat").GetComponent<Collider2D>();
